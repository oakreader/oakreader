...
public enum BuiltInProviders {
    ...
    public static let anthropic = ProviderInfo(
        ...
        models: [
            ModelInfo(id: "claude-opus-4-8", name: "Claude Opus 4.8", providerId: "anthropic", contextWindow: 1_000_000, maxTokens: 128_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "claude-fable-5", name: "Claude Fable 5", providerId: "anthropic", contextWindow: 1_000_000, maxTokens: 128_000, reasoning: true, supportsVision: true),
    ...
    public static let google = ProviderInfo(
        ...
        models: [
            ModelInfo(id: "gemini-3.1-pro-preview", name: "Gemini 3.1 Pro Preview", providerId: "google", contextWindow: 1_048_576, maxTokens: 65_536, reasoning: true, supportsVision: true),
            ModelInfo(id: "gemini-3.5-flash", name: "Gemini 3.5 Flash", providerId: "google", contextWindow: 1_048_576, maxTokens: 65_536, reasoning: true, supportsVision: true),
            ModelInfo(id: "gemini-3.1-flash-lite", name: "Gemini 3.1 Flash Lite", providerId: "google", contextWindow: 1_048_576, maxTokens: 65_536, reasoning: true, supportsVision: true),
            ModelInfo(id: "gemini-3-pro-preview", name: "Gemini 3 Pro Preview", providerId: "google", contextWindow: 1_048_576, maxTokens: 65_536, reasoning: true, supportsVision: true),
        ],
    ...
    public static let xai = ProviderInfo(
        ...
        models: [
            ModelInfo(id: "grok-4.3", name: "Grok 4.3", providerId: "xai", contextWindow: 1_000_000, maxTokens: 30_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "grok-4.20-0309-reasoning", name: "Grok 4.20 (Reasoning)", providerId: "xai", contextWindow: 1_000_000, maxTokens: 30_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "grok-4.20-0309-non-reasoning", name: "Grok 4.20 (Non-Reasoning)", providerId: "xai", contextWindow: 1_000_000, maxTokens: 30_000, reasoning: false, supportsVision: true),
            ModelInfo(id: "grok-code-fast-1", name: "Grok Code Fast 1", providerId: "xai", contextWindow: 32_768, maxTokens: 8_192, reasoning: false, supportsVision: false),
            ModelInfo(id: "grok-3", name: "Grok 3", providerId: "xai", contextWindow: 131_072, maxTokens: 8_192, reasoning: false, supportsVision: false),
            ModelInfo(id: "grok-3-fast", name: "Grok 3 Fast", providerId: "xai", contextWindow: 131_072, maxTokens: 8_192, reasoning: false, supportsVision: false),
        ],
    ...
    public static let mistral = ProviderInfo(
        ...
        models: [
            ...
            ModelInfo(id: "mistral-medium-3.5", name: "Mistral Medium 3.5", providerId: "mistral", contextWindow: 262_144, maxTokens: 262_144, reasoning: true, supportsVision: true),
            ModelInfo(id: "mistral-medium-latest", name: "Mistral Medium (latest)", providerId: "mistral", contextWindow: 262_144, maxTokens: 262_144, reasoning: false, supportsVision: true),
    ...
    public static let kimi = ProviderInfo(
        ...
        models: [
            ModelInfo(id: "kimi-k2.7-code", name: "Kimi K2.7 Code", providerId: "kimi", contextWindow: 262_144, maxTokens: 262_144, reasoning: true, supportsVision: true),
            ModelInfo(id: "kimi-k2.6", name: "Kimi K2.6", providerId: "kimi", contextWindow: 262_144, maxTokens: 262_144, reasoning: true, supportsVision: true),
    ...
    public static let minimax = ProviderInfo(
        ...
        models: [
            ModelInfo(id: "MiniMax-M3", name: "MiniMax-M3", providerId: "minimax", contextWindow: 512_000, maxTokens: 128_000, reasoning: true, supportsVision: true),
    ...
    public static let zai = ProviderInfo(
        ...
        models: [
            ModelInfo(id: "glm-5.2", name: "GLM-5.2", providerId: "zai", contextWindow: 1_000_000, maxTokens: 131_072, reasoning: true, supportsVision: false),
    ...
    public static let openaiCodex = ProviderInfo(
        ...
        defaultModelId: "gpt-5.5",
        models: [
            // Reconciled to pi's current openai-codex set (chatgpt.com/backend-api).
            ModelInfo(id: "gpt-5.5", name: "GPT-5.5", providerId: "openai-codex", contextWindow: 272_000, maxTokens: 128_000, reasoning: true, supportsVision: true),
            ...
            ModelInfo(id: "gpt-5.4-mini", name: "GPT-5.4 mini", providerId: "openai-codex", contextWindow: 272_000, maxTokens: 128_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "gpt-5.3-codex-spark", name: "GPT-5.3 Codex Spark", providerId: "openai-codex", contextWindow: 128_000, maxTokens: 128_000, reasoning: true, supportsVision: false),
        ],
    ...
    public static let githubCopilot = ProviderInfo(
        ...
        models: [
            ModelInfo(id: "claude-opus-4.8", name: "Claude Opus 4.8", providerId: "github-copilot", contextWindow: 200_000, maxTokens: 64_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "claude-fable-5", name: "Claude Fable 5", providerId: "github-copilot", contextWindow: 1_000_000, maxTokens: 128_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "gpt-5.5", name: "GPT-5.5", providerId: "github-copilot", contextWindow: 400_000, maxTokens: 128_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "gpt-5.4", name: "GPT-5.4", providerId: "github-copilot", contextWindow: 400_000, maxTokens: 128_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "gemini-3.1-pro-preview", name: "Gemini 3.1 Pro Preview", providerId: "github-copilot", contextWindow: 200_000, maxTokens: 64_000, reasoning: true, supportsVision: true),
            ModelInfo(id: "gemini-3.5-flash", name: "Gemini 3.5 Flash", providerId: "github-copilot", contextWindow: 200_000, maxTokens: 64_000, reasoning: true, supportsVision: true),
