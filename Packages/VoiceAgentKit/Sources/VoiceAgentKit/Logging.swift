...
/// Centralized logging for VoiceAgentKit with an injectable sink for file logging.
///
...
public enum VoiceAgentLog {
    ...
    private static let sttLogger = Logger(subsystem: "VoiceAgentKit", category: "stt")
    private static let ttsLogger = Logger(subsystem: "VoiceAgentKit", category: "tts")
