...
5. **Stage and commit**:
   ...
   - **DO NOT** add any Codex references, co-author tags, or "Generated with" footers
...
- NEVER include AI-generated markers, Codex references, or `Co-Authored-By: Codex` footers
